...
public class GridManager : MonoBehaviour
{
    ...
    {
        Instantiate(player, new Vector3(gridTiles[playerSpawnTile].transform.position.x, 0.75f, gridTiles[playerSpawnTile].transform.position.z),player.transform.rotation);
        playerSpawned = true;
    }
